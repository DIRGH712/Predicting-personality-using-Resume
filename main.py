...
def prediction_result(top, aplcnt_name, cv_path, personality_values):
    ...
    result.iconbitmap(r"E:\projects\Personality predictor\icon3.ico")
...
def perdict_person():
    ...
    top.iconbitmap(r"E:\projects\Personality predictor\icon2.ico")
...
def OpenFile(b4):
    global loc;
    name = filedialog.askopenfilename(initialdir=r"C:\Users\patel\Desktop",
...
if __name__ == "__main__":
    ...
    root.iconbitmap(r"E:\projects\Personality predictor\icon.ico")
